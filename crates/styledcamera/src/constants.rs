...
pub(crate) static SETTING_FRAME_WIDTH: &[u8] = b"frame_width\0";
pub(crate) static SETTING_FRAME_HEIGHT: &[u8] = b"frame_height\0";
...
pub(crate) static PROP_FRAME_WIDTH: &[u8] = b"Frame width\0";
pub(crate) static PROP_FRAME_HEIGHT: &[u8] = b"Frame height\0";
