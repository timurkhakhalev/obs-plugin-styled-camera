...
pub(crate) static SETTING_FRAME_INSET_LEFT: &[u8] = b"frame_inset_left\0";
pub(crate) static SETTING_FRAME_INSET_TOP: &[u8] = b"frame_inset_top\0";
pub(crate) static SETTING_FRAME_INSET_RIGHT: &[u8] = b"frame_inset_right\0";
pub(crate) static SETTING_FRAME_INSET_BOTTOM: &[u8] = b"frame_inset_bottom\0";
...
pub(crate) static PROP_FRAME_INSET_LEFT: &[u8] = b"Frame left\0";
pub(crate) static PROP_FRAME_INSET_TOP: &[u8] = b"Frame top\0";
pub(crate) static PROP_FRAME_INSET_RIGHT: &[u8] = b"Frame right\0";
pub(crate) static PROP_FRAME_INSET_BOTTOM: &[u8] = b"Frame bottom\0";
